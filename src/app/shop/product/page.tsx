...
const ProductDetails = () => {
  ...
  if(!id) return <section className="h-screen flex justify-center items-center">Loading...</section>
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="text-2xl text-primary font-medium mb-6">₹ {price}</div>
